...
// clutch.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CclutchApp, CWinApp)
...
// Единственный объект CclutchApp

CclutchApp theApp;


// Инициализация CclutchApp

BOOL CclutchApp::InitInstance()
{
